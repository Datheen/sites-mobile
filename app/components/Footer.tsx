...
<footer className="bg-[#131c40] text-white">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <a href="https://flowbite.com/" className="flex items-center">
                  <img src="/img/logo.webp" className="w-40" alt="FlowBite Logo" />
                 
              </a>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  <h2 className="mb-6 text-sm font-semibold text-heading text-gold uppercase">Recursos</h2>
                  <ul className="text-body font-medium">
                      <li className="mb-4">
                          <a href="https://flowbite.com/" className="hover:underline">Civix Advocacia</a>
                      </li>
                      <li>
              ...
              <div>
                  <h2 className="mb-6 text-sm font-semibold text-heading uppercase text-gold">Siga nós</h2>
                  <ul className="text-body font-medium">
                      <li className="mb-4">
              ...
              <div>
                  <h2 className="mb-6 text-sm font-semibold text-heading uppercase text-gold">Legal</h2>
                  <ul className="text-body font-medium">
                      <li className="mb-4">
                          <a href="#" className="hover:underline">Política e Privacidade</a>
                      </li>
                      <li>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-body sm:text-center">© 2025 <a href="https://flowbite.com/" className="hover:underline">Civix Advocacia</a>  -  Todos os direitos reservados.
          </span>
