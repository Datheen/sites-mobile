function Footer() {
  return (
    <div>
      <footer className="bg-[#131c40] text-white z-10 2xl:mt-40">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                <h2 className="mb-6 text-sm font-semibold text-heading text-gold uppercase">
                  Recursos
                </h2>
              ...
              <div>
                <h2 className="mb-6 text-sm font-semibold text-heading uppercase text-gold">
                  Siga nós
                </h2>
                <ul className="text-body font-medium">
                  <li className="mb-4">
